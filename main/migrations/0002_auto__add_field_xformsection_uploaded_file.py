...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XFormSection.uploaded_file'
        db.add_column('main_xformsection', 'uploaded_file', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XFormSection.uploaded_file'
        db.delete_column('main_xformsection', 'uploaded_file')
    ...
    models = {
        ...
        'main.xformsection': {
            ...
            'uploaded_file': ('django.db.models.fields.files.FileField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
