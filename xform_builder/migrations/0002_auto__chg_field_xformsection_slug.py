...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'XFormSection.slug'
        db.alter_column('xform_builder_xformsection', 'slug', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'XFormSection.slug'
        db.alter_column('xform_builder_xformsection', 'slug', self.gf('django.db.models.fields.CharField')(max_length=32))
